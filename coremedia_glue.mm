...
CoreMediaLibraryInternal(const CoreMediaLibraryInternal&);
CoreMediaLibraryInternal& operator = (const CoreMediaLibraryInternal&);
//static CoreMediaLibraryInternal* m_pInstace;

 public:
 static CoreMediaLibraryInternal& GetInstance()
 {
	static CoreMediaLibraryInternal m_pInstace;
	return m_pInstace;
 }
...
//static CoreMediaLibraryInternal g_coremedia_handle=CoreMediaLibraryInternal::GetInstance();

// static
CoreMediaGlue::CMTime CoreMediaGlue::CMTimeMake(int64_t value,
                                                int32_t timescale) {
  return CoreMediaLibraryInternal::GetInstance().cm_time_make()(value, timescale);
}
...
OSStatus CoreMediaGlue::CMBlockBufferCreateContiguous(
  ...
  return CoreMediaLibraryInternal::GetInstance().cm_block_buffer_create_contiguous_method()(
      structureAllocator,
      sourceBuffer,
      blockAllocator,
      customBlockSource,
...
size_t CoreMediaGlue::CMBlockBufferGetDataLength(CMBlockBufferRef theBuffer) {
  return CoreMediaLibraryInternal::GetInstance().cm_block_buffer_get_data_length_method()(
      theBuffer);
}
...
OSStatus CoreMediaGlue::CMBlockBufferGetDataPointer(CMBlockBufferRef theBuffer,
                                                    ...
                                                    size_t* totalLength,
                                                    char** dataPointer) {
  return CoreMediaLibraryInternal::GetInstance().cm_block_buffer_get_data_pointer_method()(
...
Boolean CoreMediaGlue::CMBlockBufferIsRangeContiguous(
    ...
    size_t offset,
    size_t length) {
  return CoreMediaLibraryInternal::GetInstance().cm_block_buffer_is_range_contiguous_method()(
...
CoreMediaGlue::CMBlockBufferRef CoreMediaGlue::CMSampleBufferGetDataBuffer(
  ...
  return CoreMediaLibraryInternal::GetInstance().cm_sample_buffer_get_data_buffer_method()(
      sbuf);
}
...
CoreMediaGlue::CMSampleBufferGetFormatDescription(
  ...
  return CoreMediaLibraryInternal::GetInstance().cm_sample_buffer_get_format_description_method()(sbuf);
}

// static
CVImageBufferRef CoreMediaGlue::CMSampleBufferGetImageBuffer(
    CMSampleBufferRef buffer) {
  return CoreMediaLibraryInternal::GetInstance().cm_sample_buffer_get_image_buffer_method()(
      buffer);
}
...
CFArrayRef CoreMediaGlue::CMSampleBufferGetSampleAttachmentsArray(
  ...
  return CoreMediaLibraryInternal::GetInstance().cm_sample_buffer_get_sample_attachments_array_method()(
          sbuf, createIfNecessary);
}

// static
CFStringRef CoreMediaGlue::kCMSampleAttachmentKey_NotSync() {
  return *CoreMediaLibraryInternal::GetInstance().k_cm_sample_attachment_key_not_sync();
}

// static
FourCharCode CoreMediaGlue::CMFormatDescriptionGetMediaSubType(
      CMFormatDescriptionRef desc) {
  return CoreMediaLibraryInternal::GetInstance().cm_format_description_get_media_sub_type_method()(desc);
}
...
CoreMediaGlue::CMVideoDimensions
  ...
  return CoreMediaLibraryInternal::GetInstance().cm_video_format_description_get_dimensions_method()(videoDesc);
}
...
OSStatus CoreMediaGlue::CMVideoFormatDescriptionGetH264ParameterSetAtIndex(
  ...
  return CoreMediaLibraryInternal::GetInstance().cm_video_format_description_get_h264_parameter_set_at_index_method()(
          videoDesc,
          parameterSetIndex,
